         ...
         <div class="row"></div>
            <div class="col-md-6">
                ...
                <div class="form-group mb-3">
                   ...
                   <input type="text" name="nama" id="nis" value="{{ $siswa->nama }}" class="form-control"/>
                    @error('nama')
                          <span class="text-danger">{{ $message }}</span>
                     @enderror
               </div> 
               ...
               <div class="form-group mb-3">
                  ...
                  <div class="form check">
                      ...
                      value="L" @if ($siswa->jenis_kelamin == 'l') checked @endif>
               ...
               <div class="form check">
                <input type="radio" class="form-check-input"
                 ...
                 value="P" @if ($siswa->jenis_kelamin == 'p') checked @endif>
             ...
             <div class="form-group mb-3">
                ...
                <input type="text" name="tempat_lahir" value="{{ $siswa->tempat_lahir }}" id="tempat_lahir" class="form-control">
                 @error('tempat_lahir')
                          <span class="text-danger">{{ $message }}</span>
                     @enderror
             </div>
            ...
            <div class="form-group mb-3">
                ...
                <input type="date" name="tanggal_lahir" value="{{ $siswa->tanggal_lahir }}"id="tanggal_lahir" class="form-control">
                 @error('tanggal_lahir')
                          <span class="text-danger">{{ $message }}</span>
                     @enderror
            </div>
